  ...
  return (
    <ScrollView style={styles.container}>
        ...
        <View style={styles.headerContent}>
          <View>
            <View style={styles.profile}>
              <View>
                <Text style={styles.username}>Locyse</Text>
              </View>
      ...
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>Beranda</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.activityCard}>
          ...
          <View style={styles.activityContent}>
            <Text style={styles.activityTitle}>Scan Absensi Berhasil</Text>
        ...
        <View style={styles.activityCard}>
          ...
          <View style={styles.activityContent}>
            <Text style={styles.activityTitle}>Kang Sur Absen</Text>
